...
SwitchBinary_Get = 0x02
SwitchBinary_Report = 0x03
SwitchMultilevel_Set = 0x01
SwitchMultilevel_Get = 0x02
SwitchMultilevel_Report = 0x03
SwitchMultilevel_StartLevelChange = 0x04
SwitchMultilevel_StopLevelChange = 0x05
SwitchMultilevel_SupportedGet = 0x06
SwitchMultilevel_SupportedReport = 0x07
SwitchAll_Set = 0x01
SwitchAll_Get = 0x02
SwitchAll_Report = 0x03
SwitchAll_On = 0x04
SwitchAll_Off = 0x05
SwitchToggleBinary_Set = 0x01
SwitchToggleBinary_Get = 0x02
SwitchToggleBinary_Report = 0x03
SceneActivation_Set = 0x01
SceneActuatorConf_Set = 0x01
SceneActuatorConf_Get = 0x02
SceneActuatorConf_Report = 0x03
SceneControllerConf_Set = 0x01
SceneControllerConf_Get = 0x02
SceneControllerConf_Report = 0x03
SensorBinary_Get = 0x02
SensorBinary_Report = 0x03
SensorMultilevel_SupportedGet = 0x01
SensorMultilevel_SupportedReport = 0x02
SensorMultilevel_Get = 0x04
SensorMultilevel_Report = 0x05
Meter_Get = 0x01
Meter_Report = 0x02
Meter_SupportedGet = 0x03
Meter_SupportedReport = 0x04
Meter_Reset = 0x05
ColorSwitch_SupportedGet = 0x01
ColorSwitch_SupportedReport = 0x02
ColorSwitch_Get = 0x03
ColorSwitch_Report = 0x04
ThermostatMode_Set = 0x01
ThermostatMode_Get = 0x02
ThermostatMode_Report = 0x03
ThermostatMode_SupportedGet = 0x04
ThermostatMode_SupportedReport = 0x05
ThermostatSetpoint_Get = 0x02
ThermostatSetpoint_Report = 0x03
ThermostatSetpoint_SupportedGet = 0x04
ThermostatSetpoint_SupportedReport = 0x05
DoorLockLogging_SupportedGet = 0x01
...
MultiInstance_Report = 0x05
MultiInstance_Encap = 0x06
MultiInstance_ChannelEndPointGet = 0x07
MultiInstance_ChannelEndPointReport = 0x08
MultiInstance_ChannelCapabilityGet = 0x09
MultiInstance_ChannelCapabilityReport = 0x0a
MultiInstance_ChannelEndPointFind = 0x0b
MultiInstance_ChannelEndPointFindReport = 0x0c
MultiInstance_ChannelEncap = 0x0d
DoorLock_Set = 0x01
DoorLock_Get = 0x02
DoorLock_Report = 0x03
DoorLock_ConfigurationSet = 0x04
DoorLock_ConfigurationGet = 0x05
DoorLock_ConfigurationReport = 0x06
UserCode_Set = 0x01
UserCode_Get = 0x02
UserCode_Report = 0x03
UserCode_NumberGet = 0x04
UserCode_NumberReport = 0x05
...
Alarm_Report = 0x05
Alarm_Set = 0x06
Alarm_SupportedGet = 0x07
Alarm_SupportedReport = 0x08
ManufacturerSpecific_Get = 0x04
ManufacturerSpecific_Report = 0x05
ManufacturerSpecific_DeviceSpecificGet = 0x06
ManufacturerSpecific_DeviceSpecificReport = 0x07
Powerlevel_Set = 0x01
Powerlevel_Get = 0x02
Powerlevel_Report = 0x03
Powerlevel_TestNodeSet = 0x04
Powerlevel_TestNodeGet = 0x05
Powerlevel_TestNodeGetReport = 0x06
Protection_Set = 0x01
Protection_Get = 0x02
...
NodeNaming_Set = 0x01
NodeNaming_Get = 0x02
NodeNaming_Report = 0x03
NodeNaming_LocationSet = 0x04
NodeNaming_LocationGet = 0x05
NodeNaming_LocationReport = 0x06
Firmware_MetadataGet = 0x01
Firmware_MetadataReport = 0x02
Battery_Get = 0x02
Battery_Report = 0x03
Clock_Set = 0x04
Clock_Get = 0x05
Clock_Report = 0x06
Hail_Hail = 0x01
WakeUp_IntervalSet = 0x04
WakeUp_IntervalGet = 0x05
WakeUp_IntervalReport = 0x06
WakeUp_Notification = 0x07
WakeUp_NoMoreInformation = 0x08
WakeUp_IntervalCapabilitiesGet = 0x09
WakeUp_IntervalCapabilitiesReport = 0x0a
Association_Set = 0x01
Association_Get = 0x02
Association_Report = 0x03
Association_Remove = 0x04
Association_GroupingsGet = 0x05
Association_GroupingsReport = 0x06
Version_Get = 0x11
Version_Report = 0x12
Version_CommandClassGet = 0x13
Version_CommandClassReport = 0x14
Indicator_Set = 0x01
Indicator_Get = 0x02
Indicator_Report = 0x03
TimeParameters_Set = 0x01
TimeParameters_Get = 0x02
TimeParameters_Report = 0x03
Security_SupportedGet = 0x02
Security_SupportedReport = 0x03
Security_SchemeGet = 0x04
Security_SchemeReport = 0x05
Security_NetworkKeySet = 0x06
Security_NetworkKeyVerify = 0x07
Security_SchemeInherit = 0x08
Security_NonceGet = 0x40
Security_NonceReport = 0x80
Security_MessageEncap = 0x81
Security_MessageEncapNonceGet = 0xc1
SensorAlarm_Get = 0x01
SensorAlarm_Report = 0x02
SensorAlarm_SupportedGet = 0x03
SensorAlarm_SupportedReport = 0x04
